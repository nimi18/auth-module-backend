...
const { signupLimiter, loginLimiter, forgotLimiter } = require("../middleware/rateLimit.middleware");
...
router.post("/social/:provider", loginLimiter, asyncHandler(socialController.socialLogin));
